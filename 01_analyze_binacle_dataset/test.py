...
text = "  \u001b[91mE: Package 'iproute' has no installation candidate  \u001b[0mThe command '/bin/sh -c apt-get update     && apt-get -y install       curl       jq       netcat       net-tools       iproute       dnsutils       graphviz' returned a non-zero code: 100 "
print(keyGen(text))