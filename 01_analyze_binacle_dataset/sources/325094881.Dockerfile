...
# pilot-agent and mosn may run with effective uid 0 in order to run mosn with
...
# RUN \
# chgrp 1337 /usr/local/bin/mosn /usr/local/bin/pilot-agent && \
# chmod 2755 /usr/local/bin/mosn /usr/local/bin/pilot-agent
