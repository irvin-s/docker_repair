...
#  
###############################################################################  
# Docker image for Support Alerts & Notifications micro service  
# FROM java:8  
FROM alpine:3.4  
MAINTAINER Cloud Tsai <cloud_tsai@dell.com>  
  
RUN apk --update add openjdk8-jre  
  
# environment variables  
ENV APP_DIR=/edgex/edgex-support-notifications  
ENV APP=support-notifications.jar  
ENV APP_PORT=48060  
