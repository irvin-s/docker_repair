# golangci-lint
# docker run --rm -v $(pwd):/go/src/github.com/your-name/project -w /go/src/github.com/your-name/project supinf/golangci-lint:1.11 run --config .golangci.yml

FROM alpine:3.8

ENV GOLANGCI_LINT_VERSION=1.11.3 \
...
RUN apk --no-cache add --virtual build-deps bash openssl go git \
    ...
    && GOLANGCI_LINT_SHA256="c1c2911f1ab06efca52595863864133b4b5b8cd86ca1861b2846b296eee89f4b" \
