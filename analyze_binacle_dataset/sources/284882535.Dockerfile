...
LABEL name="eXist-db Minimal Docker with working xslfo module" \
  vendor="Evolved Binary Ltd" \
  org.label-schema.schema-version="1.0" \
  org.label-schema.name="eXist-db Minimal Docker with working xslfo module" \
...
COPY /target/exist-minimal /exist
