FROM snapcraft/xenial-amd64:2.24
MAINTAINER Rex Tsai "http://about.me/chihchun"

ENV UBUNTUIMAGE_VERSION=0.12+16.04ubuntu1
...
RUN echo "ALL ALL=NOPASSWD: /snap/bin/ubuntu-image, /bin/mount" >> /etc/sudoers.d/ubuntu-image \
