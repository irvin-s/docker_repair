...
# SugarCRM 7.21 MAX
ENV DOWNLOAD_URL http://iweb.dl.sourceforge.net/project/suitecrm/suitecrm-7.1.6.zip
ENV DOWNLOAD_FILE suitecrm-7.1.6-max.zip
ENV EXTRACT_FOLDER suitecrm-7.1.6-max
