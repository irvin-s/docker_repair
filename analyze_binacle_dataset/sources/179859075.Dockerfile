...
RUN wget https://github.com/vivo-project/VIVO/archive/rel-1.8.1.zip
RUN unzip rel-1.8*.zip
RUN wget https://github.com/vivo-project/Vitro/archive/rel-1.8.1.zip
RUN unzip rel-1.8*.zip.1
RUN mv VIVO-rel-1.8.1 VIVO-rel
RUN mv Vitro-rel-1.8.1 VIVO-rel/vitro-core
