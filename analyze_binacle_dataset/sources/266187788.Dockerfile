...
COPY turuturu /app/turuturu
COPY flag /app/flag

RUN chown root:root turuturu flag
RUN chmod 755 turuturu flag
...
# Run Program
CMD socat TCP-LISTEN:5000,reuseaddr,fork EXEC:./turuturu,su=nobody
