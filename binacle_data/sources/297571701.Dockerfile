...
LABEL maintainer="Jaeyoung Chun (chunj@mskcc.org)" \
      version.image="1.0.0" \
      version.replaceallelcounts="0.1.0" \
      version.alpine="3.6" \
      source.replaceallelecounts="https://github.com/mskcc/replace_allele_counts/releases/tag/0.1.0"

ENV REPLACEALLELECOUNTS_VERSION 0.1.0
