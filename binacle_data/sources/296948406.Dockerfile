...
RUN apt-get update
RUN apt-get install -y nginx mysql-client php5-cli php5-fpm python-setuptools vim php5-mysql php5-curl
...
# Copy PHP files
ADD ./usr/share/nginx/html/discover.php /usr/share/nginx/html/discover.php
