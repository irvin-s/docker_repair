...
RUN apt-get -y update && apt-get -y install python python3-pip python3-dev libssl-dev dpkg-dev build-essential libjpeg-dev libtiff-dev libsdl2-dev libgstreamer-plugins-base0.10-dev libnotify-dev freeglut3 freeglut3-dev libsm-dev libgtk-3-dev ibus-gtk3 xvfb wget fuse libhunspell-dev git
